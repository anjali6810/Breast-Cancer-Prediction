...
Success Criteria: 
a. Business success criteria: Increase the correct diagnosis of cancer in at least 96% of patients
b. Machine Learning success criteria: Achieve an accuracy of atleast 95%
c. Economic success criteria: Reducing medical expenses will improve trust of patients and thereby hospital 
will see an increase in revenue by atleast 10%

Data Collection:
Data is collected from the hospital for 569 patients. 32 features (inputs) and 1 label(output) comprise the feature set. 
...
k) id (patient application number)
l) sex (Gender - male and female)
m) Diagnosis - Target / Label'''
...
cancerdata = pd.read_csv(r"C:\Users\Bharani Kumar\Desktop\KNN\cancerdata.csv")
